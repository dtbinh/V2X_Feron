...
% ==============================================
%Nota: esta hecho para recibir en L3 del transmisor una sola trama cuando
%vamos por la 7
%%
...
%Nota: no entiendo la funcion de NcycleIx
...
for tested_subframe = 0:numTotSubframes-1
    ...
    if tested_subframe==data_arrived_subframe        
        ...
        %Nota: h_slV2XComm_tx.ls_PSSCH_RP -> PSSCH_RP (Resource pool)
        %subframes que se pueden transmitir
        ...
        %Nota: le carga al transmisor el sdu length o LSubChannel
        %configurando MCS
    ...
    elseif ismember(tested_subframe, h_slV2XComm_tx.l_PSSCH_selected)   
        ...
        %Nota: solo muestra 50 de los 88 bits
